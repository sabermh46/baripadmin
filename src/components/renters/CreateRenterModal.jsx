// components/renter/CreateRenterModal.jsx
import React, { useState } from 'react';
import { useCreateRenterMutation } from '../../store/api/renterApi';
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* NID Images */}
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-4">NID Images (Optional)</h3>
