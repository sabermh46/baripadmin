  ...
  return (
    <Routes>
      ...
      <Route element={
        ...
        <Route path="renters/create" element={
          <ProtectedRoute roles={['web_owner', 'staff', 'house_owner']}>
            <CreateRenterPage />
          </ProtectedRoute>
        } />
        ...
        <Route path="tokens/generate" element={
          <ProtectedRoute roles={['web_owner', 'staff', 'house_owner']}>
            <GenerateTokenPage />
          </ProtectedRoute>
        } />
        ...
        <Route path="invoices" element={
          <ProtectedRoute roles={['web_owner', 'staff', 'house_owner', 'flat_renter']}>
            <InvoicesPage />
          </ProtectedRoute>
        } />
        ...
        <Route path="reports/houses" element={
          <ProtectedRoute roles={['web_owner', 'staff']}>
            <HouseReportsPage />
          </ProtectedRoute>
        } />
        ...
        {/* ===== SYSTEM SETTINGS ROUTES (WEB OWNER ONLY) ===== */}
        <Route path="settings/system" element={
          <ProtectedRoute roles={['web_owner']}>
            <SystemSettingsPage />
          </ProtectedRoute>
        } />
        <Route path="settings/role-limits" element={
          <ProtectedRoute roles={['web_owner']}>
            <RoleLimitsPage />
          </ProtectedRoute>
        } />
        
        {/* ===== SPECIAL ROUTES (LOGIN AS FUNCTIONALITY) ===== */}
        <Route path="login-as" element={
          <ProtectedRoute roles={['web_owner', 'staff', 'house_owner']}>
            <LoginAsPage />
          </ProtectedRoute>
        } />
        <Route path="switch-account" element={
          <ProtectedRoute roles={['web_owner', 'staff', 'house_owner']}>
            <SwitchAccountPage />
          </ProtectedRoute>
        } />
        <Route path="impersonation-logs" element={
          <ProtectedRoute roles={['web_owner', 'staff']}>
            <ImpersonationLogsPage />
          </ProtectedRoute>
        } />
        ...
        <Route path="caretaker/assigned-houses" element={
          <ProtectedRoute roles={['caretaker']}>
            <ComingSoonPage />
          </ProtectedRoute>
        } />
        
        {/* ===== FLAT RENTER-SPECIFIC ROUTES ===== */}
        <Route path="renter/my-flat" element={
          <ProtectedRoute roles={['flat_renter']}>
            <ComingSoonPage />
          </ProtectedRoute>
        } />
        <Route path="renter/my-payments" element={
          <ProtectedRoute roles={['flat_renter']}>
            <ComingSoonPage />
          </ProtectedRoute>
        } />
        <Route path="renter/notices" element={
          <ProtectedRoute roles={['flat_renter']}>
            <ComingSoonPage />
          </ProtectedRoute>
        } />
